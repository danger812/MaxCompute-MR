package danger.odps.mr.examples.hive;
...
/**
 * JoinRunStep, mr_Join_src1/mr_Join_src2(key bigint, value string), mr_Join_out(key
 * bigint, value1 string, value2 string)
 * 出处：https://help.aliyun.com/document_detail/27894.html?spm=a2c4g.11186623.6.782.69fc42d0OS0UYY
 * 1、上传 资源， 打开ODPS客户端
 * 2、提交JOB
 * jar -resources MaxCompute-MR-1.0-SNAPSHOT.jar -classpath /data/code/MaxCompute-MR/target/MaxCompute-MR-1.0-SNAPSHOT.jar danger.odps.mr.examples.hive.Join mr_Join_src1 mr_Join_src2 mr_Join_out;
 */
public class Join {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: JoinRunStep <input table1> <input table2> <out>");
            System.exit(2);
        }
